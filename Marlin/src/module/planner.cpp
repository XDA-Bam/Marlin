...
float Planner::previous_nominal_speed_sqr;
  ...
  float Planner::extruder_advance_Ka[EXTRUDERS]; // Initialized by settings.load()
#endif
            ...
            calculate_trapezoid_for_block(block, current_entry_speed * nomr, next_entry_speed * nomr);
              ...
              if (block->use_advance_lead) {
                ...
                if(next_entry_speed < current_nominal_speed) {
                  ...
                  block->decomp_add_steps = step_diff * extruder_advance_Ka[active_extruder];
                } else {
                  block->final_adv_steps = next_entry_speed * comp;
                  block->decomp_add_steps = 0;
                }
